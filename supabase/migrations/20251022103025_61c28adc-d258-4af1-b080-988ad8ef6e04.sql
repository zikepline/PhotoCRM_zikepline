...
CREATE TABLE public.deals (
  ...
  retoucher_payment_type TEXT DEFAULT 'percent' CHECK (retoucher_payment_type IN ('percent', 'fixed')),
  retoucher_percent NUMERIC DEFAULT 0,
  retoucher_fixed NUMERIC DEFAULT 0,
  layout_payment_type TEXT DEFAULT 'percent' CHECK (layout_payment_type IN ('percent', 'fixed')),
  layout_percent NUMERIC DEFAULT 0,
  layout_fixed NUMERIC DEFAULT 0,
  tax_base TEXT DEFAULT 'net_profit' CHECK (tax_base IN ('revenue', 'net_profit')),
